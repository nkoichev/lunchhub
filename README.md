...
10. **If you already ran an older `schema.sql`** (before Blink was added as a second payout method), also run [`supabase/migration_blink_phone.sql`](supabase/migration_blink_phone.sql) once.
